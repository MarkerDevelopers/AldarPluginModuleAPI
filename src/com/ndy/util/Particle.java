...
public class Particle {
    ...
    public static void send(Player p, Location loc, float offsetX, float offsetY, float offsetZ, int speed, int count, EnumParticle particle) {
        PacketPlayOutWorldParticles packet = new PacketPlayOutWorldParticles(
                particle, true, (float) loc.getX(), (float) loc.getY(), (float) loc.getZ(), offsetX, offsetY, offsetZ, speed, count
        );
    ...
    public static void send(Location loc, float offsetX, float offsetY, float offsetZ, int speed, int count, EnumParticle particle) {
        PacketPlayOutWorldParticles packet = new PacketPlayOutWorldParticles(
                particle, true, (float) loc.getX(), (float) loc.getY(), (float) loc.getZ(), offsetX, offsetY, offsetZ, speed, count
        );
